...
public class Search {
	...
	public void user_enters_valid_product_into_search_box_field(String validProductText) {
		driver.findElement(By.xpath("//input[@class='form-control input-lg']")).sendKeys(validProductText);
	}
	...
	public void user_enters_invalid_product_into_search_box_field(String invalidProductText) {
		...
		driver.findElement(By.xpath("//input[@class='form-control input-lg']")).sendKeys(invalidProductText);
